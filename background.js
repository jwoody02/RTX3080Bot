...
((_)_((_)(_)) (_(_())  ((_)_ _ ((_)_ ((_) ((_)_  ((_)(_(_())
 ...
 console.log("background.js being called");
 //________________________________________________________________________
 ...
 if (pagetitle.includes(ITEM_KEYWORD)) {
         ...
         console.log("detected title contains keyword")
         //Create Custom Badge
         //
         const $badge = createFloatingBadge("Checking for in stock", "initializing code");
                    document.body.appendChild($badge);
         ...
         if (OOSButton.length > 0 ) {
                 //
                 //
                 const $badge = createFloatingBadge("Checking for in stock", "OUT OF STOCK: Reloading in "+OOS_REFRESH+" seconds");
                    document.body.appendChild($badge);
                    setTimeout(() => {$badge.style.transform = "translate(0, 0)";}, 0);
         ...
         //
                 ...
                 {
                    const $badge = createFloatingBadge("Checking for in stock", "product appears to be in stock!");
                    document.body.appendChild($badge);
                    setTimeout(() => {$badge.style.transform = "translate(0, 0)";}, 0);
                         ...
                         if (ATC_Color === 'rgb(197, 203, 213)')
                         {
                             ...
                             instockEventHandler() ;
                             const $badge = createFloatingBadge("Checking for in stock", "add to cart already pressed!");
                    document.body.appendChild($badge);
                    setTimeout(() => {$badge.style.transform = "translate(0, 0)";}, 0);
                         ...
                         else
                         {
                             ...
                             setTimeout(function() {
                                 ...
                                 const $badge = createFloatingBadge("Checking for in stock", "pressed add to cart!");
                    document.body.appendChild($badge);
                    setTimeout(() => {$badge.style.transform = "translate(0, 0)";}, 0);
